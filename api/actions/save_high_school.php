...
//echo $schools;
$id = 0;
foreach($schools as $province){
   // var_dump($schools);
    //echo "province：".$province->province."<br />";
    foreach ($province->schools as $key => $value) {
        # code...
        //var_dump($province->province."  ".$value->name);
        $id = $id + 1;
        // $last_user_id = $db->insert("schools", [
        //     "province" => $province->province,
        //     "school" => $value->name,
        //     "city" => $value->city
        // ]);
        $province->schools[$key]->id = $id;
        // var_dump($province->schools[$key]);
    }
} 
